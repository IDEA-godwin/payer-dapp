...
const HomeTab = ({ toggleRechargeMeter }) => {
  ...
  return (
    <>
      ...
      <div className="w-full mt-10">
        <button
          className="w-full py-6 cursor-pointer bg-black border-[#123A77] border-[1px] rounded-xl flex flex-col items-center justify-between"
          onClick={toggleRechargeMeter}
        >
          <img src="/recharge.png" alt="recharge" />
          <p>Recharge Meter</p>
        </button>
      </div>
